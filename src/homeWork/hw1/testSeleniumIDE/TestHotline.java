...
public class TestHotline {
    ...
    public void testHotline() throws Exception {
        ...
        driver.findElement(By.id("lst-ib")).sendKeys("hotline");
        driver.findElement(By.id("vs0p1")).click();
        // ERROR: Caught exception [ERROR: Unsupported command [selectWindow | name=24984 | ]]
        driver.findElement(By.cssSelector("span.close-x")).click();
        // ERROR: Caught exception [ERROR: Unsupported command [selectWindow | name=24984 | ]]
        driver.findElement(By.linkText("Компьютерная периферия")).click();
        // ERROR: Caught exception [ERROR: Unsupported command [selectWindow | name=24984 | ]]
        driver.findElement(By.linkText("Карты памяти")).click();
    }
